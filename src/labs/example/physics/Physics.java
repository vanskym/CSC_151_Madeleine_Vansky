...
/*javac -d bin src/labs/example/physics/Physics.java */
...
public class Physics {
    final static double gravity = 9.81;
        ...
        public static double getTheta(){
            ...
            xVal = keyboard.nextDouble();
            System.out.println("Please enter the second angle: ");
            yVal = keyboard.nextDouble();
        ...
        public void logValidAngleInfo(double angleInDegrees){
          ...
          double getDistance(double getLightSpeedinMph, double getTimeFromSunToEarthInHours){

                double distance;
                double v = getLightSpeedinMph;
                double t = getTimeFromSunToEarthInHours;
            ...
            /* equation = x = v * t 
                ...
                this is the original work for getDistance
